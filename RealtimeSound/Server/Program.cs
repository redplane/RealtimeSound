...
namespace Server
{
    internal class Program
    {
        ...
        //    {
        //        // Size of buffer (Megabytes)
        //        var iBufferSize = 40;
        //        var buffer = new byte[iBufferSize * 1000000];
        //        var networkStream = tcpClient.GetStream();

        //        var bufferedWaveProvider = new BufferedWaveProvider(new WaveFormat());
        //        bufferedWaveProvider.DiscardOnBufferOverflow = true;
        //        bufferedWaveProvider.BufferLength = buffer.Length;

        //        var waveOut = new WaveOut();
        //        waveOut.Init(bufferedWaveProvider);
        //        waveOut.Play();

        //        var bufferCheckerThread = new Thread(() =>
        //        {
        //            while (true)
        //            {
        //                Console.WriteLine($"Remaining : {bufferedWaveProvider.BufferedBytes}");
        //            }
        //        });

        //        bufferCheckerThread.IsBackground = true;
        //        bufferCheckerThread.Start();
        ...
        //                    //Console.WriteLine($"Read {iReadBytes} bytes");
        //                    //Console.WriteLine($"Buffer bytes = {bufferedWaveProvider.BufferedBytes}");
        //                }
        //            }
        //            catch (Exception ex)
        //            {
